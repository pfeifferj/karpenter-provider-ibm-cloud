...
func SetupE2ETestSuite(t *testing.T) *E2ETestSuite {
	...
	suite := &E2ETestSuite{
		...
		testVPC:           os.Getenv("E2E_TEST_VPC_ID"),
		testSubnet:        os.Getenv("E2E_TEST_SUBNET_ID"),
		testImage:         os.Getenv("E2E_TEST_IMAGE_ID"),
		testRegion:        os.Getenv("IBMCLOUD_REGION"),
		testZone:          os.Getenv("E2E_TEST_ZONE"),
		testSecurityGroup: os.Getenv("E2E_TEST_SECURITY_GROUP_ID"),
