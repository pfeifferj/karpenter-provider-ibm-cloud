...
func (p *IBMBootstrapProvider) generateCloudInitScript(ctx context.Context, options Options) (string, error) {
	// Create template
...
func (p *IBMBootstrapProvider) buildKubeletExtraArgs(config *KubeletConfig) string {
